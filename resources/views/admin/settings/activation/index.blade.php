							...
							<div class="col-sm-12 col-md-12">
								<div class="input-box">
									<div class="form-group">
										...
										<input type="text" class="form-control @error('license') is-danger @enderror" name="license" value="@if ($information['license']) {{ $information['license'] }} @endif" required>
										@error('license')
							...
							<div class="col-sm-12 col-md-12">
								<div class="input-box mb-1">
									<div class="form-group mb-1">
										...
										<input type="text" class="form-control @error('username') is-danger @enderror" name="username" value="@if ($information['username']) {{ $information['username'] }} @endif" required>
										@error('username')

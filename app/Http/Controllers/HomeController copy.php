...
class HomeController extends Controller
{
    ...
    {   
        if ($request->ajax()) {
            ...
            $response = $this->processText($voice, request('textarea'), 'mp3', '24khz-48kbit', $file_name);
     ...
     */
    private function processText(Voice $voice, $text, $format, $frequency, $file_name)
    {   
        $azure = new AzureTTSService();
        
        return $azure->synthesizeSpeech($voice, $text, $format, $frequency, $file_name);

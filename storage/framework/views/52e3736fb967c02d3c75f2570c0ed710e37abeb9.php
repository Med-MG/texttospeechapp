		...
		<div class="col-lg-12 col-md-12 col-xm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title"><?php echo e(__('Activated GCP TTS Voices')); ?></h3>
				</div>
							...
							<table id='allResultsTable' class='table' width='100%'>
									<thead>
										<tr>									
											...
											<th width="2%"><?php echo e(__('Vendor')); ?></th>
											<th width="7%"><?php echo e(__('Language')); ?></th>
											<th width="6%"><?php echo e(__('Language Code')); ?></th>
											<th width="5%"><?php echo e(__('Voice Name')); ?></th>
											<th width="7%"><?php echo e(__('Voice ID')); ?></th>
											<th width="3%"><?php echo e(__('Gender')); ?></th>
											<th width="5%"><?php echo e(__('Voice Engine')); ?></th>
											<th width="2%"><?php echo e(__('Sample')); ?></th>							
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\textovoice\resources\views/admin/tts-management/voices/index.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											<h6><?php echo e(__('Site Website')); ?></h6>
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											<h6><?php echo e(__('Site Email Address')); ?></h6>
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											<h6><?php echo e(__('Default New User Group')); ?></h6>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											<h6><?php echo e(__('Support Ticket Emails')); ?></h6>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											<h6><?php echo e(__('User All Voices Panel')); ?></h6>
											<select id="user-voices" name="user-voices" data-placeholder="Enable/Disable User All Voices Panel">	
												<option value="enabled" <?php echo e((config('settings.user_voices') == 'enabled') ? 'selected' : ''); ?>><?php echo e(__('Enable')); ?></option>
												<option value="disabled" <?php echo e((config('settings.user_voices') == 'disabled') ? 'selected' : ''); ?>><?php echo e(__('Disable')); ?></option>																		
											</select> 
										</div> 
									</div>
								</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\textovoice\resources\views/admin/settings/global/index.blade.php ENDPATH**/ ?>
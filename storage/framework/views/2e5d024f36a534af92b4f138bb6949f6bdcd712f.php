...
unset($__errorArgs, $__bag); ?>" name="license" value="<?php if($information['license']): ?> <?php echo e($information['license']); ?> <?php endif; ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="username" value="<?php if($information['username']): ?> <?php echo e($information['username']); ?> <?php endif; ?>" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\textovoice\resources\views/admin/settings/activation/index.blade.php ENDPATH**/ ?>
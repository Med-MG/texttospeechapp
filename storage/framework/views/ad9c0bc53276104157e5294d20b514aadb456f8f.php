...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
	<head>
		...
		<!--Google AdSense-->
		<?php if(config('adsense.status') == 'on'): ?><?php echo Adsense::javascript(); ?> <?php endif; ?>
											...
											<nav class="navbar navbar-expand-lg navbar-light w-100" id="navbar-responsive">
												...
												<div class="collapse navbar-collapse" id="navbarNav">
													<ul class="navbar-nav">
														...
														<?php endif; ?>									
														<?php if(config('frontend.voices_section') == 'on'): ?>
															<li class="nav-item">
																<a class="nav-link scroll <?php echo e(Request::path() === 'all-voices' ? 'active' : ''); ?>" href="<?php echo e(route('all.voices')); ?>"><?php echo e(__('Voices')); ?></a>
															</li>
														<?php endif; ?>
														<?php if(config('frontend.blogs_section') == 'on'): ?>
															<li class="nav-item">
																<a class="nav-link <?php echo e(Request::path() === 'blogs' ? 'active' : ''); ?>" href="#blog-wrapper"><?php echo e(__('Blogs')); ?></a>
															</li>
														<?php endif; ?>
														<?php if(config('frontend.faq_section') == 'on'): ?>
															<li class="nav-item">
																<a class="nav-link <?php echo e(Request::path() === 'faqs' ? 'active' : ''); ?>" href="#faq-wrapper"><?php echo e(__('FAQs')); ?></a>
															</li>
														<?php endif; ?>
							...
							<div class="col-md-8 col-sm-12" id="footer-links">
								...
								<div class="row w-100">
									...
									<div class="col-md-3 col-sm-12">				
										...
										<ul class="list-unstyled">
											<li><a href="<?php echo e(route('all.voices')); ?>">All Voices</a></li>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\textovoice\resources\views/layouts/guest.blade.php ENDPATH**/ ?>
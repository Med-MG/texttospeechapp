...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		...
		<ol class="breadcrumb mb-2">
			<li class="breadcrumb-item"><a href="<?php echo e(route('user.tts')); ?>"><i class="fa-solid fa-wand-sparkles mr-2 fs-12"></i><?php echo e(__('User')); ?></a></li>
								...
								<div class="col-md-3 col-sm-12">
									<div class="row">
										<div class="col-md-10 col-sm-10 pr-0" id="project-box">
											<div class="form-group">
												<select id="project" name="project" data-placeholder="<?php echo e(__('Select Project Name')); ?>">	
													<option value="all"> <?php echo e(__('All Projects')); ?></option>
										...
										<div class="col-md-2 col-sm-2" id="add-project-box">
											<div class="dropdown">
												<button class="btn btn-special create-project" type="button" id="add-project" data-tippy-content="<?php echo e(__('Create New Project')); ?>"><i class="fa-solid fa-rectangle-history-circle-plus"></i></button>											
											</div>
										</div>
									</div>
								</div>
							...
							<?php if(config('tts.ssml_effect') == 'enable'): ?>
								<div class="row mb-6">
									...
									<div class="col-md col-sm-12 special-buttons" id="upload-file">
										<div class="dropdown">
											<button class="btn btn-special" type="button" onclick="readFile();" id="read-file"><?php echo e(__('Upload File')); ?></button>									
										</div>
									</div>
								</div>
							<?php endif; ?>							
											...
											<div id="textarea-row-box">
												<div class="textarea-row" id="maintextarea">
													...
													<div class="textarea-text">
														<textarea class="form-control textarea" name="textarea[]" id="ZZZOOOVVVZ" data-voice="" onkeyup="countCharacters();" onmousedown="mouseDown(this);" rows="1" placeholder="<?php echo e(__('Enter your text here to synthesize')); ?>..." maxlength="3000"></textarea>
													</div>
                                ...
                                <div class="row">
									...
									<div class="col-sm-12">
										<div id="controls" class="mt-4 mb-3">
											...
											<?php if( config('tts.listen_download')  == 'enable'): ?> <a id="downloadBtn" class="result-play result-play-sm" href="" download><i class="fa fa-download"></i></a> <?php endif; ?>							
										</div> 
									</div>
								</div>                                            
							</div>
...
<?php $__env->startSection('js'); ?>
	...
	<script type="text/javascript">
		$(function () {
			...
			let user_voice = "<?php echo e(auth()->user()->voice); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\textovoice\resources\views/user/tts/index.blade.php ENDPATH**/ ?>
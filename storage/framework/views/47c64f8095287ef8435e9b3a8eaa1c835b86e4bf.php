...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		...
		<ol class="breadcrumb mb-2">
			<li class="breadcrumb-item"><a href="<?php echo e(route('user.tts')); ?>"><i class="fa-solid fa-folder-music mr-2 fs-12"></i><?php echo e(__('User')); ?></a></li>
					...
					<table id='resultsTable' class='table' width='100%'>
							<thead>
								<tr>
									...
									<th width="4%"><?php echo e(__('Vendor')); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\textovoice\resources\views/user/tts-results/index.blade.php ENDPATH**/ ?>